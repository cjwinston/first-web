...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('ttttttttttttttttttttt', 'test@example.com', 'FlaskIsAwesome')
    ...
    def test_invalid_email_registration(self):
        ...
        response2 = self.register('test2', 'test2example.com', 'FlaskIsAwesome')
